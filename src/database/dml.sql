...
--- codigo 
insert into Codigo(nome, descricao, code, id_item) values ('Código', 'Esse código será utilizado para desbloquear o próximo nível. Guarde-o com cuidado!', '303', 1); 
insert into Codigo(nome, descricao, code, id_item) values ('Código', 'Esse código será utilizado para desbloquear o próximo nível. Guarde-o com cuidado!', '175',2); 
insert into Codigo(nome, descricao, code, id_item) values ('Código', 'Esse código será utilizado para desbloquear o próximo nível. Guarde-o com cuidado!', '12', 3); 
